...
AppForge includes a built-in server monitoring dashboard powered by [Oshi](https://github.com/oshi/oshi), providing real-time visibility into system resources directly from the admin panel.
